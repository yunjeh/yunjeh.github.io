...
async function initUnifiedRatings() {
    ...
    // 💡 [중요] 배열에 currentYear만 남겨서 '올해' 잔디밭만 그리도록 설정합니다.
    ...
    try {
        ...
        // 3. 추출된 점수를 기반으로 CSS 클래스(레벨 0~10) 부여
